...
input-file:
  - Microsoft.Portal/preview/2025-09-01-preview/CloudShell.json
```

### Tag: package-preview-2023-02-01-preview

These settings apply only when `--tag=package-preview-2023-02-01-preview` is specified on the command line.

```yaml $(tag) == 'package-preview-2023-02-01-preview'
input-file:
  - Microsoft.Portal/preview/2023-02-01-preview/CloudShell.json
```

### Tag: package-preview-2020-04-01-preview

These settings apply only when `--tag=package-preview-2020-04-01-preview` is specified on the command line.

```yaml $(tag) == 'package-preview-2020-04-01-preview'
input-file:
